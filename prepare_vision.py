...
# Usar el entorno virtual recién creado
venv_path = os.path.join(os.getcwd(), "venv_vision", "Scripts", "python.exe")
...
with open("god_vision_test.py", "w", encoding="utf-8") as f:
    f.write(script_content)

print("Script 'god_vision_test.py' creado. Esperando a que termine la instalación para ejecutar.")
